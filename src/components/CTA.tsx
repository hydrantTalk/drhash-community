...
export default function CTA() {
  ...
  return (
    <section ref={sectionRef} className="py-24 md:py-32 px-6 relative">
      {/* Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] rounded-full bg-purple-600/5 blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-2xl mx-auto text-center">
        ...
        <div className="cta-anim opacity-0" onMouseMove={onMouseMove} onMouseLeave={onMouseLeave}>
          <a
            ...
            className="magnetic-btn inline-flex px-10 py-4 rounded-full bg-gradient-to-r from-purple-600 to-pink-500 text-white font-bold text-base tracking-wide hover:shadow-[0_0_50px_rgba(139,92,246,0.35)] transition-shadow duration-500"
          >
            {m.cta?.btn}
          </a>
        </div>
